...
static struct ff_lock *timeout_operations_lock;
...
void ff_core_initialize()
{
	...
	timeout_operations_lock = ff_lock_create();
...
void ff_core_shutdown()
{
	...
	ff_lock_delete(timeout_operations_lock);
