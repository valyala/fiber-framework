...
FF_API void *ff_blocking_queue_get(struct ff_blocking_queue *queue);

FF_API int ff_blocking_queue_get_with_timeout(struct ff_blocking_queue *queue, int timeout, void **data);
